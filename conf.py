...
BLOG_AUTHOR = "GCC"  # (translatable)
BLOG_TITLE = "Games Creators Club PiWars Blog"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "http://piwars.raspberrypilot.com/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://raspberrypilot.com/"
BLOG_EMAIL = "edward@raspberrypilot.com"
BLOG_DESCRIPTION = "This is PiWars blog web site of Games Creators Club"  # (translatable)
...
# is in the manual.
COMMENT_SYSTEM_ID = "raspberrypilot"
